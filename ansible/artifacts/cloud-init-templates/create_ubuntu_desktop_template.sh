...
# Source the image
wget $template_image -O $template_name.iso

apt-get install libguestfs-tools -y
virt-customize -a $template_name.iso --install qemu-guest-agent
...
qm importdisk $template_id $template_name.iso $template_storage
