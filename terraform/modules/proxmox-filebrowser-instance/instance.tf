...
resource "null_resource" "this" {
  ...
  provisioner "file" {
    ...
    destination = "/var/lib/vz/snippets/cloud_init_ubuntu_filebrowser-${random_string.deployment_id.result}.yml"
  }
}
...
resource "proxmox_vm_qemu" "this" {
  ...
  cicustom   = "user=local:snippets/cloud_init_ubuntu_filebrowser-${random_string.deployment_id.result}.yml"
